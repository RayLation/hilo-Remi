...
class HiloChallengeSensor(HiloEntity, RestoreEntity, SensorEntity):
    ...
    - appreciation: Currently in appreciation phase, a special phase provided by this integration in order to boost rewards
    ...
    precold_start: datetime
    precold_end: datetime
    ...
    async def _async_update(self):
        ...
        for raw_event in events:
            ...
            if (self.events_count == 0): 
                ...
                self.reduction_start = event.reduction_start
                self.reduction_end = event.reduction_end
                self.recovery_start = event.recovery_start
